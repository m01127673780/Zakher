...
@section('title')
@Lang('admin.sliders') | @Lang('admin.edit') {{$slide->title}}
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body pt-3 pb-3">
                        ...
                        <div class="container-fluid">
                                ...
                                <form action="{{route('dashboard.sliders.update',  $slide->id)}}" method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    {{ method_field('put')}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" rows="3" name="{{ $locale }}[description]"
                                            class="form-control @error($locale. '.description') is-invalid @enderror">{{ $slide->translate($locale)->description }} </textarea>
