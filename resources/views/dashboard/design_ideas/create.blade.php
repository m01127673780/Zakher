...
@section('title')
@Lang('admin.design_ideas') | @Lang('admin.add')
@endsection
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body pt-3 pb-3">
                        ...
                        <div class="container-fluid">
                            ...
                            <form action="{{route('dashboard.design_ideas.store')}}" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" name="image[]"
                                            multiple="multiple" id="customFile">
    ...
    $('#customFile').on('change', function (e) {
        ...
        $.each(files, function (i, file) {
                ...
                reader.onload = function (e) {
                        var template = '<img src="' + e.target.result + '" style="width: 150px" class="img-thumbnail" alt="">';
